...
<div class="center">
    <header>
        <span class="pCount">My Menu Details</span>
        <label><i>Total：</i><b class="duiqi" id="total">0</b><b class="duiqi">&nbsp;SGD</b></label>
    </header>
   
    <section>
        <article>
            <h2>My Menu
                <button class="btn_add emptyIt" id="clearBtn">Clear</button>
                <button class="btn_add" onclick="location.href='<?php  echo create_url('mobile/module', array('do' => 'waplist', 'from_user' => $page_from_user, 'name' => 'idish', 'weid' => $weid, 'storeid' => $storeid))?>'">+Add Food</button>
            </h2>
            <ul class="myorder" id="myorder">
                ...
                <li>
                    ...
                    <i><?php  echo $item['productprice'];?> SGD</i>
                    <?php  } else { ?>
                    <i><?php  echo $item['marketprice'];?> SGD<span class="yuanjia"><?php  echo $item['productprice'];?> SGD</span></i>
                    <?php  } ?>
            ...
            <div id="form_dish" target="hide">
                ...
                <table class="table_book">
                    ...
                    <tr style="display:none">
                        ...
                        <td colspan="2">
                            <input type="tel" id="tel" name="tel" value="000000" maxlength="13" style="width: 200px;"></td>
                    </tr>
                    <tr style="display:none">
                        <td style="width: 80px;">用户姓名：</td>
                        <td style="width: 50%;">
                            <input type="text" name="guest_name" id="name" value="client" maxlength="10" style="width: 100px;">
                        </td>
                        <td>
                    ...
                    <tr style="display:none" >
                        ...
                        <td colspan="2">
                            <input type="text" id="counts" name="counts" value="1" maxlength="3" style="width: 100px;">
                        </td>
                    </tr>
                    <tr class="in" id="tr_tables">
                        <td style="width: 80px;">Room No./Table No.</td>
                        <td colspan="2">
                            <input type="tel" id="tables" name="tables"  maxlength="3" style="width: 100px;">
                        </td>
                    </tr>
                    <tr  style="display:none">
                        ...
                        <td colspan="2">
                            <div class="group_radio">
                                ...
                                <span>
                                    <input type="radio" name="seat_type" value="1" checked>
                                    <label>大厅</label>
                                </span>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td style="width: 80px; vertical-align: top; line-height: 25px;">Remark：</td>
                        <td colspan="2">
                ...
                <footer>
                    <input type="button" value="Order Now" class="btn_2" id="submit_form">
                </footer>
            </div>
        </article>
    </section>
    ...
    $("#submit_form").click(function () {
        ...
        if (bool) {
            MDialog.confirm(
                ...
                'Confirm', function(){
                    postmain();
                }, null, 'Cancel', null, null,null, true, true
            );
        }
    });
});
