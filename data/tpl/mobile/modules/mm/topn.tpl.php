			...
			<a href="#" data-ajax="false">
				<div class="TheArmoryList" >
			    	...
			    	<dl class="Thefirst Theranking">
			            ...
			            <dd>
			            	<span style="color:#000">姓名:</span><a data-ajax="false" style="color:#000;font-weight:normal;" href='mobile.php?act=module&id=<?php  echo $item['id'];?>&weid=<?php  echo $_W['weid'];?>&name=mm&do=detail'><?php  echo $item['title'];?></a>
