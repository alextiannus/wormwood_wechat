...
<head>
	...
	<meta name="keywords" content="WORMWOOD,微信,微信公众平台" />
	<meta name="description" content="WORMWOOD，专注高校微信公众平台开发" />
	...
	<link type="text/css" rel="stylesheet" href="./themes/mobile/style30/style/iscroll.css">
	<link type="text/css" rel="stylesheet" href="./themes/mobile/style30/style/rain.css">
	...
	<script type="text/javascript" src="./themes/mobile/style30/style/iscroll.js"></script>
	<!--[if IE 7]>
	...
	/*快捷菜单*/
	.footer-menu{position:fixed;bottom:10px;left:10px;z-index: 999;}
	...
	<?php  } ?>
	/*rain1*/
	<?php  $b = $_W['styles']['indexbgimg'];?>
	#rain1 {
    background: url(<?php  if(empty($b)) { ?>http://bcs.duapp.com/baeimg/1joroYYvQI.jpg<?php  } else { ?><?php  echo $b;?><?php  } ?>) no-repeat scroll 0 bottom #530337;/*微站背景*/
    background-size: 100% 100%;
    }
    #rain1 .catemenu li {border-top: 1px solid rgba(0, 0, 0, 0.17);}
    #rain1 .catemenu a {border-right: 1px solid rgba(0, 0, 0, 0.17);color: #FFFFFF;}
    #rain1 .catemenu {background-color: rgba(255, 255, 255, 0.14);}
    .copyright {color: rgba(255, 255, 255, 0.48);}
	</style>
