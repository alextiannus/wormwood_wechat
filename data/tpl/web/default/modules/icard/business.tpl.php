...
<div class="main">
		...
		<table class="tb">
                ...
                <td>
                    <div id="" class="uneditable-input reply-edit-cover">
                        <div class="detail">
                            ...
                            <button type="button" class="btn btn-mini reply-news-edit-cover-remove" id="upload-delete" onclick="doDeleteItemImage(this, 'hidlogo')" style="<?php  if(empty($reply['logo'])) { ?> display:none;<?php  } ?>"><i class="icon-remove"></i> 删除</button>
                        </div>
                        <?php  if(!empty($reply['logo'])) { ?>
                            ...
                            <div id="upload-file-view" class="upload-view" style="width: 100px;">
                                ...
                                <img width="100" src="<?php  echo $_W['attachurl'];?><?php  echo $reply['logo'];?>">
                            </div>
                        <?php  } else { ?>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="info" id="info" value="<?php  if(empty($reply)) { ?>微时代会员卡，方便携带收藏，永不挂失<?php  } else { ?><?php  echo $reply['info'];?><?php  } ?>" class="span7" >
                </td>
            </tr>
			...
			<tr>
				...
				<td>
                    <input type="text" name="tel" id="tel" value="<?php  echo $reply['tel'];?>" class="span7">
				</td>
			</tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="address" id="address" value="<?php  echo $reply['address'];?>" class="span7" >
                </td>
            </tr>
            <tr>
...
<!--<script type="text/javascript">-->
    <!--$(function () {-->
        <!--var op = {-->
            <!--lat: "<?php  if($reply['lat']!='0.0000000000' && !empty($reply['lat'])) { ?><?php  echo $reply['lat'];?><?php  } else { ?>23.367896<?php  } ?>",-->
            <!--lng: "<?php  if($reply['lng']!='0.0000000000' && !empty($reply['lng'])) { ?><?php  echo $reply['lng'];?><?php  } else { ?>116.735049<?php  } ?>",-->
            <!--adr: "<?php  if(!empty($reply['place'])) { ?><?php  echo $reply['place'];?><?php  } else { ?>广东省汕头市龙湖区长平路韩江大厦<?php  } ?>"-->
        <!--}-->
        <!--baidu_map(op);-->
    <!--})-->
<!--</script>-->
