...
<script type="text/javascript">
    $(function () {
        $('#highcharts-0').highcharts({
            ...
            series: [{
                name: "新增会员人数",
                data: [<?php  echo $user_str;?>],
                pointStart: Date.UTC(<?php  echo $y;?>,<?php  echo $m;?>,<?php  echo $d;?>),
                    ...
                    <div class="box-content">
                        <div class="row">
                            <div class="area">
                                ...
                                <div class="total">
                                    <span class="start-time"><?php  echo $premonth;?></span>
                                    到<span class="end-time"><?php  echo $nowmonth;?></span>
                                    共新增<?php  echo $usercount;?>名会员
                                </div>
                                </div>
                                <div class="right">
                                    <h4 class="txt-1">新增会员</h4>
                                    <div class="sep sep1"></div>
                                    <h1 class="count-1"><?php  echo $user_today_count;?></h1>
                                    <h4 class="txt-2">今日新增会员</h4>
                                    <h1 class="count-2"><?php  echo $user_yesterday_count;?></h1>
                                    <h4 class="txt-3">昨日新增会员</h4>
                                    <div class="sep sep2"></div>
                                    <span class="txt-4">目前会员共计<?php  echo $user_total_count;?>人</span>
                                </div>
                            </div>
                            <div class="row consume">
                                <div class="area">
                                    ...
                                    <div class="total">
                                        <span class="start-time"><?php  echo $premonth;?></span>
                                        到<span class="end-time"><?php  echo $nowmonth;?></span>
                                        共消费<?php  echo $moneycount;?>次
                                    </div>
                                </div>
                                <div class="right">
                                    <h4 class="txt-1">消费次数</h4>
                                    <div class="sep sep1"></div>
                                    <h1 class="count-1"><?php  echo $consume_today_count;?></h1>
                                    <h4 class="txt-2">今日消费次数</h4>
                                    <h1 class="count-2"><?php  echo $consume_yesterday_count;?></h1>
                                    <h4 class="txt-3">昨日消费次数</h4>
                                    <div class="sep sep2"></div>
                                    <span class="txt-4">目前消费共计<?php  echo $consume_total_count;?>次</span>
                                </div>
                            </div>
                        </div>
                    </div>
