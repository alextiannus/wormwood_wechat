...
<link rel="stylesheet" type="text/css" href="./source/modules/idish/template/css/uploadify_t.css?v=2" media="all" />
<style>
    .item_box img{
        width: 100%;
        height: 100%;
...
<div class="main">
        ...
        <h4>商家编辑 - <a href="<?php  echo create_url('site/module', array('do' => 'SetRule', 'name' => 'idish'));?>" style="font-size:0.8em">入口设置</a></h4>
		<table class="tb">
            <tr>
                <th>是否显示</th>
                <td>
                    ...
                    <label class="radio inline">
                        <input type="radio" name="is_show" value="0" <?php  if(empty($reply['is_show'])) { ?>checked<?php  } ?>>隐藏
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="displayorder" value="<?php  echo $reply['displayorder'];?>" id="displayorder" class="span7" />
                </td>
            </tr>
			<tr>
				<th><label for="">商家名称</label></th>
				<td>
                    <input type="text" name="title" value="<?php  echo $reply['title'];?>" id="title" class="span7" />
				</td>
			</tr>
            <tr>
                ...
                <td>
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;"><?php  if($reply['logo']) { ?><img src="<?php  echo $_W['attachurl'];?><?php  echo $reply['logo'];?>" width="200" /><?php  } ?></div>
                        <div>
                            <input type="hidden" value="<?php  echo $reply['logo'];?>" name="logo_old">
                            <span class="btn btn-file"><span class="fileupload-new">选择图片</span><span class="fileupload-exists">更改</span><input name="logo" type="file" /></span>
            ...
            <tr>
                ...
                <td>
                    <select name="category_f" id="category_f" class="valid span2"></select>
                    <select name="category_s" id="category_s" class="span2"></select>
                    <script type="text/javascript" src="./source/modules/idish/template/js/category.js"></script>
            ...
            <tr>
                <th>商家简介</th>
                <td>
                    <textarea style="height:100px;" name="info" id="info" class="span7" cols="60" rows="2"><?php  echo $reply['info'];?></textarea>
                    <div class="help-block">门店列表页显示的商家描述信息.</div>
                </td>
            </tr>
            <tr>
                <th><label for="">营业时间</label></th>
                <td>
                    <input type="text" name="hours" value="<?php  if(empty($reply)) { ?>9:00 ~ 22:00<?php  } else { ?><?php  echo $reply['hours'];?><?php  } ?>" id="hours" class="px" style="width:200px;" />
                </td>
            </tr>
            <tr>
                <th><label for="">门店实景</label></th>
                <td>
                    <div id="upimg_main">
                        ...
                        <ul class="ipost-list ui-sortable" id="fileList">
                            <?php  if(is_array($reply['thumbArr'])) { foreach($reply['thumbArr'] as $row) { ?>
                            <li class="imgbox">
			...
			<tr>
				...
				<td>
                    <input type="text" name="tel" id="tel" value="<?php  echo $reply['tel'];?>" class="px" style="width:200px;">
				</td>
			</tr>
            <tr>
                ...
                <td>
                    ...
                    <script type="text/javascript" src="./source/modules/idish/template/js/region_select.js"></script>
                    <script type="text/javascript">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="address" id="address" value="<?php  echo $reply['address'];?>" class="px" style="width:200px;">
                </td>
            </tr>
            <tr>
...
var bmap = {
    'option' : {
        ...
        'point' : {'lng' : "<?php  if($reply['lng']!='0.0000000000' && !empty($reply['lng'])) { ?><?php  echo $reply['lng'];?><?php  } else { ?>116.735049<?php  } ?>", 'lat' : "<?php  if($reply['lat']!='0.0000000000' && !empty($reply['lat'])) { ?><?php  echo $reply['lat'];?><?php  } else { ?>23.367896<?php  } ?>"}
    },
