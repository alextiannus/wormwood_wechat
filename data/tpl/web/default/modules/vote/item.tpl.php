...
<div class='voteitem' style='float:left;width:225px;margin-bottom:5px;margin-right:5px;padding:5px;border:1px solid #ccc'>
    <input name="option_title[]" type="text" class="span3 item_title" value=""/>
    <input name="option_id[]" type="hidden" class="span3" value="<?php  echo $tag;?>" />
    
    <div class="fileupload fileupload-new <?php  if($type!='image') { ?>hide<?php  } ?> item-image" tabindex="-1" data-provides="fileupload" style='margin-top:5px;width:225px;'>
        ...
        <div style='float:left;margin-left:5px;'>
            <span class="btn btn-file">
                <span class="fileupload-new">选择图片</span><span class="fileupload-exists">更改</span><input name="option_thumb_<?php  echo $tag;?>" type="file"  class='vote_img_file'/></span>
