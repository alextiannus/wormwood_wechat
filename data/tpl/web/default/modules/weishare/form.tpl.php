<?php defined('IN_IA') or exit('Access Denied');?><div id="form" class="alert alert-block alert-new ">
	<h4 class="alert-heading">选择要分享的活动</h4>
	<table>
		<tr>
			<th>操作</th>
			<td style="width:400px;">
				<div class="reply-news-edit-button">
					<button class="btn" style="width:100%;" type="button" onclick="$('#modal-module-menus').modal();">选择要分享的活动</button>
				</div>
			</td>
		</tr>
		<tr >
			<th>分享活动信息</th>
			<td>
				<input class="input-xlarge" id="b_title" type="text" placeholder="请选择要推广的 微品牌" disabled value="<?php  echo $share['title'];?>">
		...
		<tr>
			<th>图文标题</th>
			<td>
				<input type="text" name="new_title" value="<?php  echo $reply['new_title'];?>"/>
			</td>
			</tr>
		...
		<tr>
			...
			<tr>
				<th>图文说明</th>
			<td>
				  <textarea style="height:200px; width:500px;" class="richtext-clone" name="new_desc" id="new_desc"><?php  echo $reply['new_desc'];?></textarea>
			</td>
