...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo create_url('site/module/award', array('name' => 'credit', 'op' => 'post'));?>">添加</a></li>
	<li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo create_url('site/module/award', array('name' => 'credit', 'op' => 'display'));?>">管理</a></li>
</ul>
		...
		<table class="tb">
			...
			<tr>
				...
				<td>
					...
					<span class="help-block">超过该日期后不可兑奖,日期格式必须为<b>2020-10-10 00-00-00</b></span>
				</td>
			</tr>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:right;">
						<a href="<?php  echo create_url('site/module/award', array('name' => 'credit', 'award_id' => $item['award_id'], 'op' => 'post'))?>" title="编辑" class="btn btn-small"><i class="icon-edit"></i></a>
						<a href="<?php  echo create_url('site/module/award', array('name' => 'credit', 'award_id' => $item['award_id'], 'op' => 'delete'))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;" title="删除" class="btn btn-small"><i class="icon-remove"></i></a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
