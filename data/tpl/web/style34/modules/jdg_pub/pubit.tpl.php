...
<form action="" class="form-horizontal form" method="post" enctype="multipart/form-data" onsubmit="return checkit()">
	...
	<table class="tb">
				    <tr>
						...
						<td><input type="text" name="pub_name" id="pub_name" value="<?php  echo $item['pub_name'];?>" class="span5"></td>
						</tr>
						<tr>
					...
					<tr>
						...
						<td><textarea style="height:150px;" id="txt" name="txt" class="span7" cols="60"><?php  echo $item['txt'];?></textarea>
		...
		<tr>
						...
						<td><input type="text" name="address1" value="<?php  echo $item['address'];?>" class="span6">
					</tr>
					<tr>
						<th><label for="">电话：</label></th>
						<td><input type="text" name="tel" value="<?php  echo $item['tel'];?>" class="span3" id="tel">
					</tr>
		<tr>
			<th></th>
			<td>
				<button type="submit" class="btn btn-primary span3" name="submit" value="提交">提交</button>
				<?php  if(!empty($item['pub_name'])) { ?>
...
var bmap = {
	'option' : {
		...
		'point' : {'lng' : <?php  echo $item['lng'];?>, 'lat' : <?php  echo $item['lat'];?>}
	},
