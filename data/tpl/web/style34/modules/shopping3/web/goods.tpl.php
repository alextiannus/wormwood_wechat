	...
	<form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
		...
		<table class="tb">
			<tr>
				...
				<td>
					<input type="text" name="displayorder" class="span2" value="<?php  echo $item['displayorder'];?>" />  <input type="checkbox" name="isindex" value="1" <?php  if($item['isindex']==1) { ?>checked<?php  } ?> >是否首页推荐
				</td>
			</tr>
			<tr>
				<th>分类</th>
			...
			<tr>
				...
				<td>
					<div id="upimg_main">
 					...
 					<span class="help-block" style="clear:both">商品展示图片，第一张默认为商品缩略图</span>					
				</td>
			</tr>	
			<tr>
