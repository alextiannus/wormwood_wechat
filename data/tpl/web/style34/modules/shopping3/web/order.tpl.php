			...
			<div class="stat-div">
				<div class="navbar navbar-static-top">
					<div class="navbar-inner">
						<span class="brand">订单统计<small>[不包含截止日期当天]</small></span>
						...
						<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td style="text-align:left;"><?php  if($item['order_type']==2) { ?><span class="label label-info">[店内]</span><?php  } else { ?><span class="label label-info">[外卖]</span><?php  } ?><?php  if(!empty($item['guest_address'])) { ?>地址：<?php  echo $item['guest_address'];?><?php  } else { ?>桌号：<?php  echo $item['desk'];?><?php  } ?></td>
