	...
	if($ispost) {
		...
		if (empty($error_msg)) {
			...
			if($_POST['install'] == 'remote') {
				...
				if($ins['error']) {
					die('<script type="text/javascript">alert("链接WORMWOOD更新服务器失败, 错误为: ' . $ins['error'] . '！");history.back();</script>');
				}
...
<title>WORMWOOD - 微信公众平台自助开源引擎</title>
<link href="./resource/wormwood/css/install.css" rel="stylesheet" type="text/css" />
...
<div class="header">
	<div class="top">
		...
		<div class="top-link">
			<ul>
				<li><a href="http://www.wormwood.com" target="_blank">WORMWOOD官方网站</a></li>
				<li><a href="http://bbs.wormwood.com" target="_blank">WORMWOOD官方论坛</a></li>
			</ul>
		</div>
	</div>
</div>
...
function tpl_install_license() {
	echo <<<EOF
		...
		<div class="pr-agreement">
				<p>版权所有 (c)2013，WORMWOOD团队保留所有权利。 </p>
				<p>感谢您选择WORMWOOD - 微信公众平台自助开源引擎（以下简称WQ，WQ基于 PHP + MySQL的技术开发，全部源码开放。</p>
			...
			<strong>二、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改 WORMWOOD 源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>二、协议规定的约束和限制 </strong>
				...
				<p>4、未经官方许可，禁止在 WORMWOOD 的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>三、有限担保和免责声明 </strong>
				...
				<p>3、电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装WORMWOOD，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
...
<div class="notice">
	系统要求WORMWOOD整个安装目录必须可写, 才能使用WORMWOOD所有功能.
</div>
<div class="btn-box">
	...
	<table width="726" border="0" align="center" cellpadding="0" cellspacing="0" class="twbox">
		<tr>
			...
			<td>
				...
				<p><small>在线安装能够直接安装最新版本WORMWOOD系统, 如果在线安装困难, 请下载离线安装包后使用本地安装.</small></p>
