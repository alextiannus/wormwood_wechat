$(document).ready(function() {
	...
	$("#sitting-form").on("submit", function( event ){
		...
		var url = $("input#myurl").val();
		var data = "phone=" + phone + "&weixin=" + weixin + "&id="+$("input#id").val();
	...
	$("#wish-form").on("submit", function( event ){
		...
		var url = $("input#myurl_1").val();;
		var data = "content=" + encodeURIComponent(content)+ "&id="+$("input#id").val();
