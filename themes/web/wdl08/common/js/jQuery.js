...
$.extend({
	...
	isString:function(string){
		...
		if ($.type(string)==="string"){return true}else{return false;}
	...
	isBoolean:function(string){
		...
		if ($.type(string)==="boolean"){return true}else{return false;}
	...
	mix: function(r, s, ov, wl) {
		...
		*/
		...
		就是说如果s里面有很多对象，但是我只想将其中的某几个复制到r中，这时我们就可以在wl中指定你要复制的对象
		...
		*/
		...
		这里就很简单了，如果ov==true则直接讲s里面的所有对象以覆盖的模式复制到r中，否则就复制r中没有的对象
		...
		Extjs中有个Ext.apply和Ext.applyIf两个方法来事项这个功能
